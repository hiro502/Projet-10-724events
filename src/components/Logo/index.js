...
const Logo = ({ size }) => (
  <div className="Logo">
    ...
    >
      ...
      <text fill="url(#paint5_linear_56_57)" style={{'fontFamily': 'Kalimati', 'fontSize': '39px', 'fontWeight': 700, 'whiteSwfpace': 'pre'}} x="-1.125" y="44.995">724</text> 
      {/* Réécrire les propriétés en camelCase */}
      <defs>
        <linearGradient
